        ...
        <div className="bg-gradient-to-r from-pink-200 via-purple-300 to-purple-400 flex flex-col sm:flex-row text-white h-screen animate-fadeIn">
            <div className="sm:w-[50%] py-16  flex flex-col items-center sm:pt-32 sm:justify-center px-6 sm:px-12">
                <div className="text-center sm:text-left">
                    ...
                    <br />
                    <span className="mt-4 block text-lg font-semibold text-gray-200">Create an account to get started</span>
            ...
            <div className="sm:w-[50%] flex flex-col items-center sm:mt-20 sm:justify-center">
                <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-xl">
                    <h1 className="text-center mt-5 font-bold text-4xl text-gray-800"><span className="text-pink-500">Sign</span> Up</h1>
                    <form onSubmit={handleSubmit} className="mt-10 space-y-6">
                        <input onChange={handleOnChange} className="w-full py-4 px-6 rounded-lg bg-gray-100 text-gray-900 shadow-md focus:outline-none focus:ring-2 focus:ring-pink-500 transition duration-300" id="username" placeholder="Enter your username" type="text" />
                        ...
                        <button type="submit" className="w-full py-4 rounded-lg bg-gradient-to-r from-pink-500 via-purple-500 to-purple-600 text-white font-bold shadow-md hover:from-pink-600 hover:via-purple-600 hover:to-purple-700 transition duration-300">Sign up</button>
                        <div className="text-center text-lg font-semibold text-gray-800">
                            Already have an account?
                            <Link to="/signin">
                                <span className="ml-2 text-pink-500 hover:underline transition duration-100">Sign In</span>
                            </Link>
                        </div>
