  ...
  return (
    <div className='bg-slate-900 flex flex-col sm:flex-row text-white h-screen'>
        ...
        <div  className='sm:w-[50%]   flex flex-col item-center sm:mt-20 sm:justify-center'>
           <div className="">
           <h1 className='text-center mt-5 font-semibold font-sans text-4xl'><span className='text-blue-300'>Sign</span> Up</h1>
            <form onSubmit={handleSubmit} className='mx-auto  flex flex-col items-center justify-center mt-10'>
                <input onChange={handleOnChange}  className='outline-none m-2 py-4 px-10 rounded-lg bg-transparent border-2 text-blue-300' id="username" placeholder='Enter your username' type="text" />
                ...
                <button type='submit' className=' mt-5 border-2 rounded-md text-blue-300  px-3 py-2 font-semibold hover:bg-blue-800 hover:text-white duration-200'>Sign up</button>
